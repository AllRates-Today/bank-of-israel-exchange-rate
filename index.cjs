'use strict';
// Bank of Israel exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/boi';
...
/** Latest rate for one pair, e.g. getRate('USD', 'ILS', { apiKey }). */
